...
Gem::Specification.new do |s|
  ...
  s.name = 'radiant-google-extension'
  s.version = '0.0.1'
  s.date = '2013-08-20'

  ## Make sure your summary is short. The description may be as long
  ## as you like.
  s.summary = "Extension to handle google tag manager/custom search engine integration."
  ...
  s.homepage = 'http://github.com/sealink/radiant-google-extension'
